        ...
        {messages.map((msg,index)=>(
          ...
          >
            ...
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[200px] text-sm rounded-lg mb-8 break-all text-white ${
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        ...
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          <input
            ...
            className='flex-1 text-sm p-3 outline-none text-white placeholder-gray-400 bg-transparent'
          />
